...
방식이 가장 좋은 결과를 냈다. 추가로 [Sink Attention](./sink-attention.md)에서 제기된 attention sink 문제에 대해서도 해결된 모습을 보여 long context extrapolation에도 유리하게 작용한다고 한다.

![](../../rnn/figures/pasted-image-20260425170717.png)
